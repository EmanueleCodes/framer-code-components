...
import { gsap, useGSAP, SplitText, ScrambleTextPlugin } from "./dist/bundle.js";
...
const ScrambledText = ({
  ...
  }, [radius, duration, speed, scrambleChars, scrambleInterval, color, scrambleColor, scramblePercentage]);
...
// Demo component with predetermined values
const ScrambleDemo = () => {
  return (
    <div style={{ 
      minHeight: '100vh', 
