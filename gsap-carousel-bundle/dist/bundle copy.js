...
var r,
  ...
  Bt = function (t, e, r, n) {
    return (
      e.parent && St(e),
      (e._start = gt(
        (P(r) ? r : r || t !== o ? Gt(t, r, e) : t._time) + e._delay
      )),
      (e._end = gt(
  ...
  Vt = function (t, e, r, n) {
    ...
    return (
      ...
      (t._dur = o),
      (t._tDur = i ? (i < 0 ? 1e10 : gt(o * (i + 1) + t._rDelay * i)) : o),
      s > 0 && !n && Nt(t, (t._tTime = t._tDur * s)),
      t.parent && Ft(t),
      r || Pt(t.parent, t),
      t
    );
  ...
  qt = function (t) {
    return t instanceof Ie ? Pt(t) : Vt(t, t._dur);
  },
  jt = { _start: 0, endTime: Z, totalDuration: Z },
  Gt = function t(e, r, n) {
    var i,
      o,
      s,
  ...
  ne = function (t) {
    return (
      ...
      function (e) {
        ...
        return re(
          e,
          r.querySelectorAll ? r : r === t ? $() || l.createElement("div") : t
        );
      }
    );
  },
    ...
    return (
      ...
      function (t, s, c) {
        ...
        if (!T) {
          ...
          for (
            T = o[b] = [],
              f = a ? Math.min(x, b) * u - 0.5 : n % x,
              p = x === w ? 0 : a ? (b * h) / x - 0.5 : (n / x) | 0,
              v = 0,
              y = w,
              _ = 0;
            _ < b;
            ...
            (d = (_ % x) - f),
              (g = p - ((_ / x) | 0)),
              (T[_] = m = l ? Math.abs("y" === l ? g : d) : O(d * d + g * g)),
              m > v && (v = m),
              m < y && (y = m);
          "random" === n && ie(T),
            (T.max = v - y),
  ...
  he = function (t) {
    for (var e, r, n, i, o = 0, s = ""; ~(e = t.indexOf("random(", o)); )
      (n = t.indexOf(")", e)),
        (i = "[" === t.charAt(e + 7)),
        (r = t.substr(e + 7, n - e - 7).match(i ? U : z)),
        (s +=
    ...
    if (t)
      if (((t = (!t.name && t.default) || t), X() || t.headless)) {
        ...
        if ((Ee(), t !== n)) {
          if (ot[e]) return;
          Tt(n, Tt(Ot(t, i), o)),
            Mt(n.prototype, Mt(i, Ot(t, o))),
            (ot[(n.prop = e)] = n),
            t.targetTest && (lt.push(n), (rt[e] = 1)),
            (e =
              ("css" === e ? "CSS" : e.charAt(0).toUpperCase() + e.substr(1)) +
              "Plugin");
        }
        Q(e, n), t.register && t.register(kr, n, fr);
      } else ge.push(t);
  },
  _e = 255,
  ve = {
  ...
  xe = function (t, e, r) {
    var n,
      ...
      c,
      f,
      p = t ? (P(t) ? [t >> 16, (t >> 8) & _e, t & _e] : 0) : ve.black;
    if (!p) {
      if (("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), ve[t]))
        ...
        if (((p = f = t.match(z)), e)) {
          if (~t.indexOf("="))
            return (p = t.match(B)), r && p.length < 4 && (p[3] = 1), p;
        } else
          (s = (+p[0] % 360) / 360),
            (a = +p[1] / 100),
            (n =
            ...
            (p[1] = ye(s, n, i)),
            (p[2] = ye(s - 1 / 3, n, i));
      else p = t.match(z) || ve.transparent;
      p = p.map(Number);
    }
    return (
      e &&
  ...
  be = function (t, e, r) {
    ...
    if (
      ...
      for (s = (i = t.replace(Te, "1").split(I)).length - 1; h < s; h++)
        a +=
          i[h] +
          (~n.indexOf(h)
            ? l.shift() || u + "0,0,0,0)"
            : (o.length ? o : l.length ? l : r).shift());
    if (!i) for (s = (i = t.split(Te)).length - 1; h < s; h++) a += i[h] + l[h];
    return a + i[s];
  },
  Te = (function () {
    var t,
    ...
    var t,
      ...
      y = function r(s) {
        ...
        if (
          ...
          for (o = 0; o < v.length; o++) v[o](u, i, f, s);
      };
    return (n = {
      time: 0,
      frame: 0,
      ...
      wake: function () {
        u &&
          (!a &&
            ...
            (l = s.document || {}),
            (q.gsap = kr),
            (s.gsapVersions || (s.gsapVersions = [])).push(kr.version),
            G(j || s.GreenSockGlobals || (!s.gsap && s) || {}),
            ge.forEach(me)),
          (r =
      ...
      sleep: function () {
        (r ? cancelAnimationFrame : clearTimeout)(t), (f = 0), (e = Z);
      },
      ...
      add: function (t, e, r) {
        var i = e
          ...
          : t;
        return n.remove(t), v[r ? "unshift" : "push"](i), Ee(), i;
      },
      remove: function (t, e) {
  ...
  Pe = function (t) {
    for (
      ...
      (r = o[a]),
        ...
        (n = r.substr(0, e)),
        (i[s] = isNaN(n) ? n.replace(Se, "").trim() : +n),
        (s = r.substr(e + 1).trim());
    return i;
  },
  Ae = function (t) {
  ...
  Xe = function (t, e, r, n) {
    ...
    return (
      pt(t, function (t) {
        for (var e in ((Ce[t] = q[t] = o), (Ce[(i = t.toLowerCase())] = r), o))
          Ce[
  ...
  Fe = function t(e, r, n) {
    var i = r >= 1 ? r : 1,
      ...
      s = (o / T) * (Math.asin(1 / i) || 0),
      a = function (t) {
        return 1 === t ? 1 : i * Math.pow(2, -10 * t) * C((t - s) * o) + 1;
      },
      l =
        "out" === e
          ? a
...
pt("Linear,Quad,Cubic,Quart,Quint,Strong", function (t, e) {
  ...
  Xe("Sine", function (t) {
    return 1 === t ? 1 : 1 - E(t * M);
  }),
  Xe("Back", Ne("in"), Ne("out"), Ne()),
  (Ce.SteppedEase =
    Ce.steps =
    q.SteppedEase =
      {
    ...
    return (
      ...
      (e.totalTime = function (t, e) {
        ...
        if (r && r.smoothChildTiming && this._ts) {
          for (Nt(this, t), !r._dp || r.parent || zt(r, this); r && r.parent; )
            r.parent._time !==
              r._start +
                (r._ts >= 0
                  ? r._tTime / r._ts
      ...
      (e.timeScale = function (t, e) {
        ...
        var r =
          this.parent && this._ts ? Yt(this.parent._time, this) : this._tTime;
        return (
          (this._rts = +t || 0),
          (this._ts = this._ps || -1e-8 === t ? 0 : this._rts),
          this.totalTime(
            Qt(-Math.abs(this._delay), this.totalDuration(), r),
            !1 !== e
          ),
          Ft(this),
          (function (t) {
      ...
      (e.startTime = function (t) {
        if (arguments.length) {
          ...
          return (
            e && (e._sort || !this.parent) && Bt(e, this, t - this._delay), this
          );
        }
        return this._start;
      }),
      ...
      (e.restart = function (t, e) {
        return (
          this.play().totalTime(t ? -this._delay : 0, L(e)),
  ...
  return (
    ...
    (s.set = function (t, e, r) {
      return (
        ...
        new Ze(t, e, Gt(this, r), 1),
        this
      );
    }),
    (s.call = function (t, e, r) {
      return Bt(this, Ze.delayedCall(0, t, e), r);
    }),
    (s.staggerTo = function (t, e, r, n, i, o, s) {
      return (
        (r.duration = e),
        ...
        (r.parent = this),
        new Ze(t, r, Gt(this, i)),
        this
      );
    }),
    (s.staggerFrom = function (t, e, r, n, i, o, s) {
      return (
        (r.runBackwards = 1),
        (Et(r).immediateRender = L(r.immediateRender)),
        this.staggerTo(t, e, r, n, i, o, s)
      );
    }),
    (s.staggerFromTo = function (t, e, r, n, i, o, s, a) {
      return (
        (n.startAt = r),
        (Et(n).immediateRender = L(n.immediateRender)),
    ...
    (s.render = function (t, e, r) {
      ...
      if (
        (this !== o && x > v && t >= 0 && (x = v), x !== this._tTime || r || w)
      ) {
        if (
          (_ !== this._time &&
            y &&
          ...
          if (
            ...
            if (
              ...
              (_ = T ? 0 : x % y ? y : x),
              (this._lock = 1),
              (this.render(_ || (m ? 0 : gt(l * u)), e, !y)._lock = 0),
              (this._tTime = x),
        ...
        if (
          ...
          this._initted ||
            ...
            (this._zTime = t),
            (_ = 0)),
          !_ && x && !e && !d && (pe(this, "onStart"), this._tTime !== x))
        )
          return this;
        if (i >= _ && t >= 0)
          for (s = this._first; s; ) {
            if (
              ((a = s._next), (s._act || i >= s._start) && s._ts && c !== s)
            ) {
          ...
          s = this._last;
          for (var k = t < 0 ? t : i; s; ) {
            if (((a = s._prev), (s._act || k <= s._end) && s._ts && c !== s)) {
              if (s.parent !== this) return this.render(t, e, r);
              if (
                (s.render(
                  s._ts > 0
        ...
        if (
          ...
          !e &&
          (this.pause(),
          (c.render(i >= _ ? 0 : -1e-8)._zTime = i >= _ ? 1 : -1),
          this._ts)
        )
          return (this._start = p), Ft(this), this.render(t, e, r);
    ...
    (s.add = function (t, e) {
      var r = this;
      if ((P(e) || (e = Gt(this, e, t)), !(t instanceof Be))) {
        if (N(t))
          return (
            t.forEach(function (t) {
              return r.add(t, e);
    ...
    (s.addPause = function (t, e, r) {
      var n = Ze.delayedCall(0, e || Z, r);
      return (
        (n.data = "isPause"), (this._hasPause = 1), Bt(this, n, Gt(this, t))
      );
    }),
    ...
    (s.getTweensOf = function (t, e) {
      for (var r, n = [], i = re(t), o = this._first, s = P(e); o; )
        o instanceof Ze
          ? _t(o._targets, i) &&
            (s
              ? (!He || (o._initted && o._ts)) &&
          ...
          Tt(
            {
              ...
              onStart: function () {
                if ((n.pause(), !r)) {
                  ...
                  h._dur !== t && Vt(h, t, 0, 1).render(h._time, !0, !0),
                    (r = 1);
                }
                a && a.apply(h, l || []);
              },
    ...
    (s.tweenFromTo = function (t, e, r) {
      return this.tweenTo(e, Tt({ startAt: { time: Gt(this, t) } }, r));
    }),
    (s.recent = function () {
      return this._recent;
    }),
      ...
      if (s._dirty) {
        for (n = s.parent; a; )
          (e = a._prev),
            ...
            (r = a._start) > l && s._sort && a._ts && !s._lock
            ...
            (a = e);
        Vt(s, s === o && s._time > i ? s._time : i, 1, 1), (s._dirty = 0);
      }
      return s._tDur;
    }),
    (i.updateRoot = function (t) {
      if ((o._ts && (xt(o, Yt(t, o)), (h = Oe.frame)), Oe.frame >= at)) {
        at += y.autoSleep || 120;
        var e = o._first;
        if ((!e || !e._ts) && y.autoSleep && Oe._listeners.length < 2) {
...
var He,
      ...
      (h = a[0]),
        ...
        h !== l[_++] &&
          ...
          (g._pt = {
            ...
            p: c || 1 === _ ? c : ",",
            s: f,
            c: "=" === h.charAt(1) ? mt(f, h) - f : parseFloat(h) - f,
  ...
  Ve = function (t, e, r, n, i, o, s, a, l, u) {
    S(n) && (n = n(i || 0, t, o));
    var h,
      c = t[e],
      f =
    ...
    if (
      ...
      return isNaN(f * n) || "" === n
        ? Ue.call(this, t, e, f, n, p, a || y.stringFilter, l)
        : ((h = new fr(
            this._pt,
            t,
            e,
  ...
  qe = function (t, e, r, n, i, o) {
    ...
    if (
        ...
        (s = new ot[t]()).init(
          ...
          s.rawVars
            ...
            : (function (t, e, r, n, i) {
                if (
                  (S(t) && (t = Ke(t, i, e, r, n)),
                  !R(t) || (t.style && t.nodeType) || N(t) || F(t))
                )
      ...
      ((r._pt = a = new fr(r._pt, i, t, 0, 1, s.render, s, 0, s.priority)),
      r !== c)
    )
  ...
  je = function t(e, i, s) {
    var a,
      ...
      Y = e._targets,
      F = e.parent,
      N = F && "nested" === F.data ? F.vars.targets : Y,
      z = "auto" === e._overwrite && !r,
      B = e.timeline;
    if (
      (B && (!P || !M) && (M = "none"),
      (e._ease = Le(M, x.ease)),
      (e._yEase = S ? Ae(Le(!0 === S ? M : S, x.ease)) : 0),
      S &&
        e._yoyo &&
        !e._repeat &&
      ...
      if (
        ((v = (d = Y[0] ? ct(Y[0]).harness : 0) && T[d.prop]),
        (a = Ot(T, rt)),
        X &&
          (X._zTime < 0 && X.progress(1),
          i < 0 && D && O && !A ? X.render(-1, !0) : X.revert(D && R ? tt : J),
          (X._lazy = 0)),
        k)
      ) {
        if (
          ...
          (e._startAt._dp = 0),
          (e._startAt._sat = e),
          i < 0 && (n || (!O && !A)) && e._startAt.revert(tt),
          O && R && i <= 0 && s <= 0)
        )
      ...
      for (
        e._pt = e._ptCache = 0, E = (R && L(E)) || (E && !R), l = 0;
        l < Y.length;
        l++
      ) {
        if (
          ((p = (c = Y[l])._gsap || ht(Y)[l]._gsap),
          (e._ptLookup[l] = m = {}),
          it[p.id] && nt.length && vt(),
          (_ = N === Y ? l : N.indexOf(c)),
          d &&
            !1 !== (g = new d()).init(c, v || a, e, _, N) &&
            ((e._pt = h =
              new fr(e._pt, c, g.name, 0, 1, g.render, g, 0, g.priority)),
          ...
          for (u in a)
            ot[u] && (g = qe(u, a, e, _, c, N))
              ? g.priority && (f = 1)
              : (m[u] = h =
                  Ve.call(e, c, u, "get", a[u], _, N, 0, T.stringFilter));
        e._op && e._op[l] && e.kill(c, e._op[l]),
          z &&
            e._pt &&
            ((He = e),
            o.killTweensOf(c, m, e.globalTime(i)),
            (y = !e.parent),
            (He = 0)),
          e._pt && E && (it[p.id] = 1);
      }
...
var Ze = (function (i) {
  function s(e, n, s, a) {
    ...
    var u,
      ...
      g,
      m,
      _ = (l = i.call(this, a ? n : Et(n)) || this).vars,
      v = _.duration,
      x = _.delay,
      w = _.immediateRender,
      b = _.stagger,
      ...
      E = _.yoyoEase,
      C = n.parent || o,
      D = (N(e) || F(e) ? P(e[0]) : "length" in n) ? [e] : re(e);
    if (
      ((l._targets = D.length ? ht(D) : $(0, !y.nullTargetWarn) || []),
      (l._ptLookup = []),
      (l._overwrite = T),
      M || b || Y(v) || Y(x))
    ) {
      if (
        ...
        for (h = 0; h < f; h++)
          ((c = Ot(n, Qe)).stagger = 0),
            ...
            m && Mt(c, m),
            (d = D[h]),
            (c.duration = +Ke(v, t(l), h, d, D)),
            (c.delay = (+Ke(x, t(l), h, d, D) || 0) - l._delay),
            !b &&
              1 === f &&
              c.delay &&
              ((l._delay = x = c.delay), (l._start += x), (c.delay = 0)),
            u.to(d, c, g ? g(h, d, D) : 0),
            (u._ease = Ce.none);
        u.duration() ? (v = x = 0) : (l.timeline = 0);
      } else if (M) {
        Et(Tt(u.vars.defaults, { ease: "none" })),
          (u._ease = Le(M.ease || n.ease || "none"));
        var S,
          A,
          X,
          z = 0;
        if (N(M))
          ...
          for (p in ((c = {}), M))
            "ease" === p || "easeEach" === p || Ge(p, M[p], c, M.easeEach);
          for (p in c)
            for (
              ...
              ((X = {
                ease: (A = S[h]).e,
                duration: ((A.t - (h ? S[h - 1].t : 0)) / 100) * v,
              })[p] = A.v),
                u.to(D, X, z),
                (z += X.duration);
    ...
    return (
      !0 !== T || r || ((He = t(l)), o.killTweensOf(D), (He = 0)),
      Bt(C, t(l), s),
    ...
    (a.render = function (t, e, r) {
      ...
      if (g) {
        if (
          ...
          if (((i = _), (c = this.timeline), this._repeat)) {
            ...
            if (
              ...
              _ === d
                ...
                ? ((i = g), s--)
                : i > g && (i = g),
              (u = this._yoyo && 1 & s) && ((f = this._yEase), (i = g - i)),
              (l = Xt(this._tTime, a)),
              i === p && !r && this._initted && s === l)
            )
              return (this._tTime = _), this;
            s !== l &&
              (c && this._yEase && Re(c, u),
          ...
          if (!this._initted) {
            if (Ht(this, m ? t : i, r, e, _)) return (this._tTime = 0), this;
            if (
              !(p === this._time || (r && this.vars.repeatRefresh && s !== l))
            )
              return this;
          ...
          if (
            ...
            (this.ratio = h = (f || this._ease)(i / g)),
            this._from && (this.ratio = h = 1 - h),
            !p && _ && !e && !l && (pe(this, "onStart"), this._tTime !== _))
          )
            return this;
          for (o = this._pt; o; ) o.r(h, o.d), (o = o._next);
          (c && c.render(t < 0 ? t : c._dur * c._ease(i / this._dur), e, r)) ||
            (this._startAt && (this._zTime = t)),
            this._onUpdate &&
              !e &&
              (m && At(this, t, 0, r), pe(this, "onUpdate")),
            this._repeat &&
              s !== l &&
              this.vars.onRepeat &&
              !e &&
            ...
            (_ !== this._tDur && _) ||
              ...
              e ||
                (m && !p) ||
                !(_ || p || u) ||
                (pe(this, _ === d ? "onComplete" : "onReverseComplete", !0),
                this._prom &&
        ...
        !(function (t, e, r, i) {
          ...
          if (
            ...
            u !== l || n || i || t._zTime === b || (!e && t._zTime))
          ) {
            if (!t._initted && Ht(t, e, i, r, c)) return;
            for (
              a = t._zTime,
                t._zTime = e || (r ? b : 0),
                r || (r = e && !a),
            ...
            e < 0 && At(t, e, 0, !0),
              ...
              c && t._repeat && !r && t.parent && pe(t, "onRepeat"),
              (e >= t._tDur || e < 0) &&
                t.ratio === u &&
                (u && St(t, 1),
                r ||
        ...
        (function (t, e, r, n, i, o, s, a) {
          ...
          if (!f)
            for (
              ...
              if (!l)
                return (
                  (We = 1), (t.vars[e] = "+=0"), je(t, s), (We = 0), a ? $() : 1
                );
              f.push(l);
            }
          for (c = f.length; c--; )
    ...
    (a.kill = function (t, e) {
      ...
      for (
        ...
        if (~f.indexOf(c[h]))
          ...
          a))
            (u = o && o[l]) &&
              (("kill" in u.d && !0 !== u.d.kill(l)) || Dt(this, u, "_pt"),
              delete o[l]),
              "all" !== s && (s[l] = 1);
...
Tt(Ze.prototype, { _targets: [], _lazy: 0, _startAt: 0, _op: 0, _onInit: 0 }),
...
var Je = function (t, e, r) {
  ...
  nr = function (t, e) {
    return S(t[e]) ? tr : A(t[e]) && t.setAttribute ? rr : Je;
  },
  ir = function (t, e) {
...
pt(
  ...
  (q.TweenMax = q.TweenLite = Ze),
  (q.TimelineLite = q.TimelineMax = Ie),
  (o = new Ie({
    sortChildren: !1,
    defaults: x,
...
var pr = [],
    ...
    t - mr > 2 &&
      ...
      pr.forEach(function (t) {
        var r,
          ...
          l = t.conditions;
        for (n in a)
          (r = s.matchMedia(a[n]).matches) && (i = 1),
            r !== l[n] && ((l[n] = r), (o = 1));
    ...
    return (
      (e.add = function (t, e, r) {
        ...
        var n,
          o,
          a,
          l = new xr(0, r || this.scope),
          u = (l.conditions = {});
        for (o in (i && !l.selector && (l.selector = i.selector),
  ...
  br = {
    ...
    defaults: function (t) {
      return t && t.ease && (t.ease = Le(t.ease, x.ease)), kt(x, t || {});
    },
    config: function (t) {
      return kt(y, t || {});
    },
    ...
    utils: {
      ...
      interpolate: function t(e, r, n, i) {
        ...
        if (!o) {
          ...
          if (!l) {
            for (s in r) Ve.call(f, e, s, "get", r[s]);
            o = function (t) {
...
(Ze.version = Ie.version = kr.version = "3.13.0"),
  (u = 1),
  X() && Ee(),
  Ce.Power0,
  Ce.Power1,
...
var Or,
    ...
    if (e in Lr && o) {
      ...
      if (
        (~(e = Ir[e] || e).indexOf(",")
          ...
          : (this.tfm[e] = s.x ? s[e] : wn(i, e)),
        e === en && (this.tfm.zOrigin = s.zOrigin),
  ...
  sn = function (t, e) {
    var r = { target: t, props: [], revert: on, save: rn };
    return (
  ...
  an = function (t, e) {
    var r = Er.createElementNS
      ...
      : Er.createElement(t);
    return r && r.style ? r : Er.createElement(t);
  },
  ln = function t(e, r, n) {
  ...
  fn = function (t) {
    var e,
      ...
      i = t.cloneNode(!0);
    (i.style.display = "block"), n.appendChild(i), Cr.appendChild(n);
    try {
      e = i.getBBox();
    } catch (t) {}
    return n.removeChild(i), Cr.removeChild(n), e;
  },
  pn = function (t, e) {
    for (var r = e.length; r--; )
  ...
  _n = function (t, e, r, n, i, o) {
    var s = new fr(t._pt, e, r, 0, 1, o ? jr : qr);
  ...
  xn = function t(e, r, n, i) {
    ...
    if (
      ...
      (a = s._gsap) && _ && a.width && f && a.time === Oe.time && !a.uncache)
    )
      return dt((u / a.width) * g);
    if (!_ || ("height" !== r && "width" !== r))
      (_ || "%" === h) &&
        !yn[ln(s, "display")] &&
        (c.position = ln(e, "position")),
      ...
      var v = e.style[r];
      (e.style[r] = g + i), (o = e[d]), v ? (e.style[r] = v) : mn(e, r);
    }
    return (
      f && _ && (((a = ct(s)).time = Oe.time), (a.width = s[d])),
      dt(m ? (o * u) / g : o && u ? (g / o) * u : 0)
    );
  },
  wn = function (t, e, r, n) {
    var i;
  ...
  bn = function (t, e, r, n) {
    ...
    var s,
      ...
      g,
      m,
      _ = new fr(this._pt, t.style, e, 0, 1, sr),
      v = 0,
      x = 0;
    if (
      ((_.b = r),
      ...
      for (; (a = I.exec(n)); )
        (f = a[0]),
          ...
          f !== (c = l[x++] || "") &&
            ((u = parseFloat(c) || 0),
            (m = c.substr((u + "").length)),
            "=" === f.charAt(1) && (f = mt(u, f) + m),
            (p = parseFloat(f)),
            (g = f.substr((p + "").length)),
            (v = I.lastIndex - g.length),
            g ||
              ((g = g || y.units[e] || m),
    ...
    } else _.r = "display" === e && "none" === n ? jr : qr;
    return W.test(n) && (_.e = 0), (this._pt = _), _;
  },
    ...
    if (e.tween && e.tween._time === e.tween._dur) {
      ...
      if ("all" === a || !0 === a) (s.cssText = ""), (n = 1);
        ...
        for (i = (a = a.split(",")).length; --i > -1; )
          (r = a[i]),
            Lr[r] && ((n = 1), (r = "transformOrigin" === r ? en : tn)),
            mn(o, r);
      n &&
        (mn(o, tn),
        l &&
  ...
  On = {
    clearProps: function (t, e, r, n, i) {
      if ("isFromStart" !== i.data) {
        var o = (t._pt = new fr(t._pt, e, r, 0, 0, kn));
  ...
  Sn = function (t) {
    var e = ln(t, tn);
    return Dn(e) ? En : e.substr(7).match(B).map(dt);
  },
  Pn = function (t, e) {
    var r,
      n,
    ...
    return s.svg && t.getAttribute("transform")
      ...
      : (l !== En ||
          ...
          ((r = t.parentNode) &&
            ...
            ((o = 1), (n = t.nextElementSibling), Cr.appendChild(t)),
          (l = Sn(t)),
  ...
  An = function (t, e, r, n, i, o) {
    ...
    r
      ? h !== En &&
        ...
        (T = l))
      : ((b = (s = dn(t)).x + (~w[0].indexOf("%") ? (b / 100) * s.width : b)),
      ...
      o &&
        (_n(o, u, "xOrigin", c, b),
        _n(o, u, "yOrigin", f, T),
        _n(o, u, "xOffset", p, u.xOffset),
        _n(o, u, "yOffset", d, u.yOffset)),
  ...
  Rn = function (t, e) {
    ...
    return (
      ...
      r.svg &&
        (r.uncache
          ? ((C = t.getBBox()),
            (I = r.xOrigin - C.x + "px " + (r.yOrigin - C.y) + "px"),
            (E = ""))
          : (E = !e && t.getAttribute("data-svg-origin")),
        An(t, E || I, !!E || r.originIsAbsolute, !1 !== r.smooth, m)),
      (d = r.xOrigin || 0),
      (g = r.yOrigin || 0),
      m !== En &&
        ((w = m[0]),
        ...
        6 === m.length
          ...
          : ((X = m[6]),
            ...
            (u = (_ = Fr(X, A)) * Xr),
            _ &&
              ((E = k * (v = Math.cos(-_)) + S * (x = Math.sin(-_))),
              (C = O * v + P * x),
              (D = X * v + A * x),
              (S = k * -x + S * v),
              (P = O * -x + P * v),
            ...
            _ &&
              ((v = Math.cos(-_)),
              (L = M * (x = Math.sin(-_)) + L * v),
              (w = E = w * v - S * x),
              (b = C = b * v - P * x),
              (T = D = T * v - A * x)),
            (l = (_ = Fr(b, w)) * Xr),
            _ &&
              ((E = w * (v = Math.cos(_)) + b * (x = Math.sin(_))),
              (C = k * v + O * x),
              (b = b * v - w * x),
              (O = O * v - k * x),
              (w = E),
            ...
            u &&
              ...
              ((u = l = 0), (h = 180 - h)),
            (s = dt(Math.sqrt(w * w + b * b + T * T))),
            (a = dt(Math.sqrt(O * O + X * X))),
            (_ = Fr(k, O)),
            (c = Math.abs(_) > 2e-4 ? _ * Xr : 0),
            (p = L ? 1 / (L < 0 ? -L : L) : 0)),
        r.svg &&
          ((E = t.getAttribute("transform")),
          (r.forceCSS = t.setAttribute("transform", "") || !Dn(ln(t, tn))),
      ...
      (r.force3D = y.force3D),
      (r.renderTransform = r.svg ? In : Rr ? Bn : Yn),
      (r.uncache = 0),
      r
    );
  },
  ...
  Xn = function (t, e, r) {
    var n = Zt(e);
    return dt(parseFloat(e) + parseFloat(xn(t, "x", r + "px", n))) + n;
  },
  Yn = function (t, e) {
    (e.z = "0px"),
  ...
  Bn = function (t, e) {
    ...
    if (v && (h !== Fn || u !== Fn)) {
      ...
      (b = parseFloat(h) * Yr),
        (w = Math.cos(b)),
        (o = Xn(_, o, T * w * -v)),
        (s = Xn(_, s, -Math.sin(b) * -v)),
        (a = Xn(_, a, M * w * -v + v));
    }
    g !== Nn && (y += "perspective(" + g + zn),
      (n || i) && (y += "translate(" + n + "%, " + i + "%) "),
      (x || o !== Nn || s !== Nn || a !== Nn) &&
        (y +=
          a !== Nn || x
      ...
      u !== Fn && (y += "rotateY(" + u + zn),
      h !== Fn && (y += "rotateX(" + h + zn),
      (c === Fn && f === Fn) || (y += "skew(" + c + ", " + f + zn),
      (1 === p && 1 === d) || (y += "scale(" + p + ", " + d + zn),
      (_.style[tn] = y || "translate(0, 0)");
  },
  In = function (t, e) {
    var r,
      n,
    ...
    (f = parseFloat(f)),
      ...
      f || p
        ? ((f *= Yr),
          ...
          (o = dt(o)))
        : ((r = g), (o = m), (n = i = 0)),
      ((T && !~(h + "").indexOf("px")) || (M && !~(c + "").indexOf("px"))) &&
        ((T = xn(_, "x", h, "px")), (M = xn(_, "y", c, "px"))),
      (v || y || x || w) &&
        ((T = dt(T + v - (v * r + y * i) + x)),
        (M = dt(M + y - (v * n + y * o) + w))),
      (l || u) &&
        ((s = _.getBBox()),
        (T = dt(T + (l / 100) * s.width)),
        (M = dt(M + (u / 100) * s.height))),
      (s =
        "matrix(" + r + "," + n + "," + i + "," + o + "," + T + "," + M + ")"),
  ...
  Hn = function (t, e, r, n, i) {
    var o,
      ...
      a = 360,
      l = D(i),
      u = parseFloat(i) * (l && ~i.indexOf("rad") ? Xr : 1) - n,
      h = n + u + "deg";
    return (
      l &&
        ("short" === (o = i.split("_")[1]) &&
      ...
      (t._pt = s = new fr(t._pt, e, r, n, u, Wr)),
      (s.e = h),
      (s.u = "deg"),
      t._props.push(r),
      s
  ...
  Un = function (t, e, r) {
    ...
    Lr))
      (o = h[i]) !== (s = n[i]) &&
        ...
        ((a = Zt(o) !== (u = Zt(s)) ? xn(r, i, o, u) : parseFloat(o)),
        (l = parseFloat(s)),
        (t._pt = new fr(t._pt, n, i, a, l - a, Hr)),
        (t._pt.u = u || 0),
        t._props.push(i));
    Wn(n, h);
  };
...
var Vn,
  ...
  Gn = {
    ...
    init: function (t, e, r, n, i) {
      ...
      (this.tween = r),
      e))
        if ("autoRound" !== c && ((s = e[c]), !ot[c] || !qe(c, e, r, n, t, i)))
          if (
            ((u = typeof s),
            (h = On[c]),
            ...
            (o = (getComputedStyle(t).getPropertyValue(c) + "").trim()),
              (s += ""),
              (Te.lastIndex = 0),
              Te.test(o) || ((f = Zt(o)), (p = Zt(s))),
              p ? f !== p && (o = xn(t, c, o, p) + p) : f && (s += f),
              this.add(T, "setProperty", o, s, n, i, 0, 0, c),
              b.push(c),
              w.push(c, 0, T[c]);
          else if ("undefined" !== u) {
            if (
              (M && c in M
                ? ((o =
                  ...
                  D(o) && ~o.indexOf("random(") && (o = he(o)),
                  Zt(o + "") ||
                    "auto" === o ||
                    (o += y.units[c] || Zt(wn(t, c)) || ""),
                  "=" === (o + "").charAt(1) && (o = wn(t, c)))
                : (o = wn(t, c)),
              (l = parseFloat(o)),
              ...
              c in Ir &&
                ("autoAlpha" === c &&
                  (1 === l && "hidden" === wn(t, "visibility") && a && (l = 0),
              ...
              if (
                ...
                "string" === u &&
                  "var(--" === s.substring(0, 6) &&
                  ((s = ln(t, s.substring(4, s.indexOf(")")))),
                  (a = parseFloat(s))),
                m ||
                ...
                (this._pt = new fr(
                  ...
                  "scaleY",
                  _.scaleY,
                  (d ? mt(_.scaleY, d + a) : a) - _.scaleY || 0,
                  Hr
                )),
                  (this._pt.u = 0),
                  b.push("scaleY", c),
                  ...
                  w.push(en, 0, T[en]),
                    ...
                    _.svg
                      ...
                      : ((p = parseFloat(s.split(" ")[2]) || 0) !== _.zOrigin &&
                          _n(this, _, "zOrigin", _.zOrigin, p),
                        _n(this, T, c, Ln(o), Ln(s)));
                  continue;
                }
                if ("svgOrigin" === c) {
                  An(t, s, 1, v, 0, this);
                ...
                if (c in Cn) {
                  Hn(this, _, c, l, d ? mt(l, d + s) : s);
                  continue;
                }
                if ("smoothOrigin" === c) {
                  _n(this, _, "smooth", _.smooth, s);
                  continue;
                }
                if ("force3D" === c) {
                  _[c] = s;
            ...
            else c in T || (c = hn(c) || c);
            if (
              g ||
              ((a || 0 === a) && (l || 0 === l) && !Br.test(s) && c in T)
            )
              a || (a = 0),
                (f = (o + "").substr((l + "").length)) !==
                  (p = Zt(s) || (c in y.units ? y.units[c] : f)) &&
                  (l = xn(t, c, o, p)),
                (this._pt = new fr(
                  this._pt,
                  g ? _ : T,
                ...
                (this._pt.u = p || 0),
                f !== p && "%" !== p && ((this._pt.b = o), (this._pt.r = Ur));
            else if (c in T) bn.call(this, t, c, o, d ? d + s : s);
...
(kr.utils.checkPrefix = hn),
  ...
  kr.registerPlugin(Gn);
var Kn = kr.registerPlugin(Gn) || kr;
Kn.core.Tween;
var $n,
  Qn,
  Zn,
  ...
  ai = function (t) {
    ...
    !(oi in t.style) &&
      ...
      (si = (oi = "msTransform") + "Origin");
    for (; e.parentNode && (e = e.parentNode); );
    if (((Qn = window), (ri = new gi()), e)) {
      ($n = e),
        (Zn = e.documentElement),
        (Jn = e.body),
        ((ni = $n.createElementNS(
  ...
  ci = function t(e) {
    return (
      "fixed" === Qn.getComputedStyle(e).position ||
      ((e = e.parentNode) && 1 === e.nodeType ? t(e) : void 0)
    );
  },
  fi = function t(e, r) {
    if (e.parentNode && ($n || ai(e))) {
      var n = hi(e),
        i = n
        ...
        u = $n.createElementNS
          ? $n.createElementNS(i.replace(/^https/, "http"), o)
          : $n.createElement(o);
      return (
        r &&
          (n
  ...
  pi = function (t, e) {
    ...
    if (t === Qn) return t;
    if (
      (h.length || h.push(fi(t, 1), fi(t, 2), fi(t, 3)), (r = l ? ei : ti), l)
    )
      u
        ? ((i = (function (t) {
            var e,
              ...
              r ||
                ...
                e
                  ...
                  : t.style.removeProperty(
                      oi.replace(/([A-Z])/g, "-$1").toLowerCase()
                    )),
              r || ri.clone()
            );
          })(t)),
        ...
        ? ((i = t.getBBox()),
          (n = (n = t.transform ? t.transform.baseVal : {}).numberOfItems
            ? n.numberOfItems > 1
              ? (function (t) {
                  for (var e = new gi(), r = 0; r < t.numberOfItems; r++)
      ...
      if (((o = s = 0), ii))
        for (
          ...
          (Qn.getComputedStyle(i)[oi] + "").length > 4 &&
            ((o = i.offsetLeft), (s = i.offsetTop), (i = 0));
      if (
        "absolute" !== (a = Qn.getComputedStyle(t)).position &&
        "fixed" !== a.position
      )
...
function mi(t, e, r, n) {
  if (!t || !t.parentNode || ($n || ai(t)).documentElement === t)
    return new gi();
  var i = (function (t) {
      for (var e, r; t && t !== Jn; )
    ...
    f = new gi(
      ...
      a.top +
        (c
          ? 0
          : Qn.pageYOffset || $n.scrollTop || Zn.scrollTop || Jn.scrollTop || 0)
    );
...
var vi,
  ...
  Hi = function () {
    return vi || (Ii() && (vi = window.gsap) && vi.registerPlugin && vi);
  },
  Wi = function (t) {
    return "function" == typeof t;
  },
  ...
  no = {},
  io = 0,
  oo = /^(?:a|input|textarea|button|select)$/i,
  so = 0,
  ao = {},
  lo = {},
  uo = function (t, e) {
  ...
  fo = function () {
    return !ro.length && vi.ticker.remove(co);
  },
  po = function (t) {
    for (var e = ro.length; e--; ) ro[e] === t && ro.splice(e, 1);
    vi.to(fo, {
      overwrite: !0,
      delay: 15,
      duration: 0,
  ...
  vo = function t(e) {
    (Pi = e.touches && Bi < e.touches.length), mo(e.target, "touchend", t);
  },
  yo = function (t) {
    (Pi = t.touches && Bi < t.touches.length), go(t.target, "touchend", vo);
  },
  xo = function (t) {
    return (
      yi.pageYOffset ||
  ...
  bo = function t(e, r) {
    go(e, "scroll", r), Mo(e.parentNode) || t(e.parentNode, r);
  },
  To = function t(e, r) {
    mo(e, "scroll", r), Mo(e.parentNode) || t(e.parentNode, r);
  },
  Mo = function (t) {
    return !(
      t &&
  ...
  ko = function (t, e) {
    ...
    return Math.max(
      0,
      Mo(t)
        ? Math.max(wi[n], bi[n]) - (yi["inner" + r] || wi[i] || bi[i])
        : t[n] - t[i]
    );
  },
  Oo = function t(e, r) {
  ...
  So = function (t) {
    if (t === yi)
      return (
        (Do.left = Do.top = 0),
        (Do.width = Do.right =
          wi.clientWidth || t.innerWidth || bi.clientWidth || 0),
        (Do.height = Do.bottom =
          (t.innerHeight || 0) - 20 < wi.clientHeight
            ? wi.clientHeight
            : t.innerHeight || bi.clientHeight || 0),
        Do
      );
    var e = t.ownerDocument || xi,
      r = Vi(t.pageX)
        ? t.nodeType || Vi(t.left) || Vi(t.top)
          ? Ei(t)[0].getBoundingClientRect()
          : t
        : {
            left: t.pageX - wo(e),
            top: t.pageY - xo(e),
            right: t.pageX - wo(e) + 1,
            bottom: t.pageY - xo(e) + 1,
          };
    return (
      Vi(r.right) && !Vi(r.width)
  ...
  Lo = function (t, e) {
    ...
    if (t === yi)
      ...
      if (e === yi || Vi(e)) return t.getBoundingClientRect();
      (r = i = 0),
        g
    ...
    return t === e
      ...
      : ((a = (s = mi(e, !0).multiply(mi(t))).apply({ x: r, y: i })),
        (l = s.apply({ x: n, y: i })),
        (u = s.apply({ x: n, y: o })),
        (h = s.apply({ x: r, y: o })),
        {
  ...
  Xo = function (t, e, r, n, i, o) {
    ...
    if (e)
      if (1 !== i && e instanceof Array) {
        if (((u.end = s = []), (l = e.length), Ui(e[0])))
          for (a = 0; a < l; a++) s[a] = uo(e[a], i);
  ...
  Fo = function (t, e) {
    for (var r, n = t.length; n--; )
      ((r = t[n]).ondragstart = r.onselectstart = e ? null : qi),
        vi.set(r, { lazy: !0, userSelect: e ? "text" : "none" });
  },
  No = function t(e) {
    return (
      "fixed" === Co(e).position ||
    ...
    Ni && !1 !== e.force3D
      ...
      (this.left = function (r, n) {
        ...
        if ((i > 2 || i < -2) && !n)
          return (
            (d = t.scrollLeft),
            vi.killTweensOf(this, { left: 1, scrollLeft: 1 }),
            this.left(-d),
      ...
      (this.top = function (r, n) {
        ...
        if ((i > 2 || i < -2) && !n)
          return (
            (p = t.scrollTop),
            vi.killTweensOf(this, { top: 1, scrollTop: 1 }),
            this.top(-p),
            void (e.onKill && e.onKill())
          );
        (r = -r) < 0
          ...
          ? ((c = (r - y) | 0), (r = y))
          : (c = 0),
          (c || o) && (this._skip || (u[ji] = s + -f + "px," + -c + a)),
          (t.scrollTop = 0 | r),
          (p = t.scrollTop);
      }),
      ...
      (this.calibrate = function (e) {
        ...
        (p = t.scrollTop),
          ...
          (h &&
            ...
            (h && !e) ||
              ...
              (_ = Math.max(0, t.scrollWidth - t.clientWidth)) &&
                (_ +=
                  ...
                  (zi ? parseFloat(o.paddingRight) : 0))),
            ...
            (u.width = "100%"),
            (u.paddingRight = _ + "px"),
            zi && (u.paddingBottom = o.paddingBottom),
            (r = t.clientWidth),
            (n = t.clientHeight),
            (g = t.scrollWidth),
            (m = t.scrollHeight),
  ...
  Bo = function (t) {
    if (Ii() && document.body) {
      ...
      (yi = window),
        (xi = document),
        (wi = xi.documentElement),
        (bi = xi.body),
        (Ti = Qi("div")),
        (Xi = !!window.PointerEvent),
        ((Mi = Qi("div")).style.cssText =
          "visibility:hidden;height:1px;top:-1px;pointer-events:none;position:relative;clear:both;cursor:grab"),
        (Li = "grab" === Mi.style.cursor ? "grab" : "move"),
        (Ai = e && -1 !== e.userAgent.toLowerCase().indexOf("android")),
        (Di =
          ("ontouchstart" in wi && "orientation" in yi) ||
        ...
        go(xi, "touchcancel", qi),
        go(yi, "touchmove", qi),
        bi && bi.addEventListener("touchstart", qi),
        go(xi, "contextmenu", function () {
          for (var t in no) no[t].isPressed && no[t].endDrag();
        }),
        (vi = ki = Hi());
    }
    var r, n, i, o, s;
    vi &&
      ((Ri = vi.plugins.inertia),
      (Yi = vi.core.context || function () {}),
      (Oi = vi.utils.checkPrefix),
      (ji = Oi(ji)),
      (Gi = Oi(Gi)),
      (Ei = vi.utils.toArray),
      (Fi = vi.core.getStyleSaver),
      (Ni = !!Oi("perspective")));
  },
  Io = (function (t) {
    var e, r;
    function n(e, r) {
      ...
      (i = t.call(this) || this),
        ki || Bo(),
        (e = Ei(e)[0]),
        (i.styles = Fi && Fi(e, "transform,left,top")),
        Ri || (Ri = vi.plugins.inertia),
        (i.vars = r = uo(r || {})),
        (i.target = e),
      ...
      var o,
        ...
        et = r.clickableTest || Yo,
        rt = 0,
        nt = e._gsap || vi.core.getCache(e),
        it = No(e),
        ot = function (t, r) {
          return parseFloat(nt.get(e, t, r));
        },
        st = e.ownerDocument || xi,
        at = function (t) {
          return (
            _o(t),
              ...
              $ = !1,
                ...
                lo.scrollLeft =
                  null != yi.pageXOffset
                    ...
                    : st.body.scrollLeft,
                a = q.pointerX - lo.scrollLeft,
                l = q.pointerY - lo.scrollTop;
              p && !i;

            )
              (n = (i = Mo(p.parentNode)) ? lo : p.parentNode),
                (o = i
                  ? {
                      bottom: Math.max(wi.clientHeight, yi.innerHeight || 0),
                      right: Math.max(wi.clientWidth, yi.innerWidth || 0),
                      left: 0,
                      top: 0,
                    }
                ...
                i &&
                  (u || h) &&
                  (yi.scrollTo(n.scrollLeft, n.scrollTop),
        ...
        ut = function (t, r) {
          var n,
            ...
            o = q.x,
            a = q.y;
          e._gsap || (nt = vi.core.getCache(e)),
            nt.uncache && vi.getProperty(e, "x"),
            z
              ...
              : ((q.y = parseFloat(e.style.top || ((i = Co(e)) && i.top)) || 0),
        ...
        ht = function (t, e, r, n) {
          return (
            ...
            Wi(t)
              ...
              : $i(t)
              ? function (n) {
                  for (var i, o, s = t.length, a = 0, l = Ji; --s > -1; )
                    (o = (i = t[s]) - n) < 0 && (o = -o),
                      o < l && i >= e && i <= r && ((a = s), (l = o));
                  return t[a];
                }
          ...
          (c = !1),
            s
              ? (s.calibrate(),
                ...
                (c = !0))
              : r.bounds &&
                ((t = Ao(r.bounds, e.parentNode)),
                B
                  ? ((q.minX = g = t.left),
                    (q.maxX = d = t.left + t.width),
                    (q.minY = _ = q.maxY = m = 0))
                  : Vi(r.bounds.maxX) && Vi(r.bounds.maxY)
                  ? ((n = Ao(e, e.parentNode)),
            ...
            r.liveSnap &&
              ...
              (o = $i(i) || Wi(i)),
              B
                ? ((T = ht(o ? i : i.rotation, g, d, 1)), (M = null))
                : i.points
                ? (k = (function (t, e, r, n, i, o, s) {
                    return (
                      ...
                      Wi(t)
                        ...
                        ? function (e) {
                            for (
                              var r, n, i, s, a = t.length, l = 0, u = Ji;
                              --a > -1;
        ...
        ft = function () {
          (q.isThrowing = !1), Po(q, "throwcomplete", "onThrowComplete");
        },
        pt = function () {
          q.isThrowing = !1;
        },
        dt = function (t, n) {
          ...
          t && Ri
            ? (!0 === t &&
                ...
                B
                  ? (t.rotation = Xo(q, o ? i : i.rotation, d, g, 1, n))
                  : (W &&
                      (t[I] = Xo(
                        q,
          ...
          if (
            ...
            if (
              ...
              Si[t.type]
                ? ((E = ~t.type.indexOf("touch")
                  ...
                  go(E, "touchcancel", bt),
                  go(st, "touchstart", yo))
                : ((E = null), go(st, "mousemove", xt)),
              (P = null),
              (Xi && E) ||
                (go(st, "mouseup", bt),
                t && t.target && go(t.target, "mouseup", bt)),
              (O = et.call(q, t.target) && !1 === r.dragClickables && !i))
            )
              return (
                go(t.target, "change", bt),
            ...
            if (
              ...
              (X = !S && !q.allowEventDefault) &&
                (_o(t), go(yi, "touchforcechange", _o)),
              t.changedTouches
              ...
              (h = lt),
              ro.push(h),
              1 === ro.length && vi.ticker.add(co),
              (l = q.pointerY = t.pageY),
              (a = q.pointerX = t.pageX),
              Po(q, "pressInit", "onPressInit"),
              (S || q.autoScroll) && Oo(e.parentNode),
              !e.parentNode ||
                !q.autoScroll ||
                s ||
                B ||
                ...
                Mi.parentNode ||
                e.getBBox ||
                ((Mi.style.width = e.parentNode.scrollWidth + "px"),
                e.parentNode.appendChild(Mi)),
              mt(),
              q.tween && q.tween.kill(),
              (q.isThrowing = !1),
              vi.killTweensOf(s || e, G, !0),
              s && vi.killTweensOf(e, { scrollTo: 1 }, !0),
        ...
        xt = function (t) {
          ...
          if (o && !Pi && q.isPressed && t) {
            ...
            S &&
            !P &&
            ((Ro.x = t.pageX - (it ? wo(st) : 0)),
            (Ro.y = t.pageY - (it ? xo(st) : 0)),
            C && C.apply(Ro, Ro),
            (n = Ro.x),
            (i = Ro.y),
            (((u = Math.abs(n - a)) !== (h = Math.abs(i - l)) &&
              ...
              (Ai && S === P)) &&
              ((P = u > h && W ? "x" : "y"),
              S && P !== S && go(yi, "touchforcechange", _o),
              !1 !== q.vars.lockAxisOnTouchScroll &&
                W &&
                U &&
                ((q.lockedAxis = "x" === P ? "y" : "x"),
                Wi(q.vars.onLockAxis) && q.vars.onLockAxis.call(q, c)),
              Ai && S === P))
              ? bt(c)
              : (q.allowEventDefault ||
                (S && (!P || S === P)) ||
          ...
          (q.pointerX = t),
            ...
            (q.x !== o || (q.y !== s && !B)) &&
              ...
              r && !1 === Po(q, "move", "onMove")
                ...
                : !q.isDragging &&
                  q.isPressed &&
                  ((q.isDragging = F = !0), Po(q, "dragstart", "onDragStart")));
        },
        bt = function t(n, i) {
          if (
            o &&
            ...
            if (
              (E
                ? (mo(E, "touchend", t),
                  ...
                  mo(st, "touchstart", yo))
                : mo(st, "mousemove", xt),
              mo(yi, "touchforcechange", _o),
              (Xi && E) ||
                (mo(st, "mouseup", t),
                n && n.target && mo(n.target, "mouseup", t)),
              (w = !1),
              f && ((K = so = eo()), (q.isDragging = !1)),
              po(lt),
              O && !p)
            )
              return (
                n && (mo(n.target, "change", t), (q.pointerEvent = c)),
                Fo(j, !1),
            ...
            for (a = j.length; --a > -1; )
              Eo(j[a], "cursor", r.cursor || (!1 !== r.cursor ? Li : null));
            if ((Bi--, n)) {
              if (
                (s = n.changedTouches) &&
                (n = s[0]) !== v &&
            ...
            return (
              p && c
                ? (_o(c), (X = !0), Po(q, "release", "onRelease"))
                : c && !f
                ? ((X = !1),
                  ...
                  (Ai && "touchmove" === c.type) ||
                    ...
                    (Po(q, "click", "onClick"),
                    eo() - rt < 300 && Po(q, "doubleclick", "onDoubleClick"),
                    (u = c.target || e),
                    (rt = eo()),
                    (h = function () {
                      rt === R ||
                    ...
                    Ai || c.defaultPrevented || vi.delayedCall(0.05, h)))
        ...
        Mt = function (t) {
          ...
          (q.isPressed || n || r) && ((a && t.detail && r && !o) || _o(t)),
            r ||
              n ||
              F ||
        ...
        kt = function (t) {
          return C
            ? { x: t.x * C.a + t.y * C.c + C.e, y: t.x * C.b + t.y * C.d + C.f }
            : { x: t.x, y: t.y };
        };
      return (
        (b = n.get(e)) && b.kill(),
        ...
        (i.endDrag = function (t) {
          return bt(t || q.pointerEvent, !0);
        }),
        (i.timeSinceDrag = function () {
          return q.isDragging ? 0 : (eo() - K) / 1e3;
        }),
        ...
        (i.getDirection = function (t, r) {
          var n,
            ...
            a,
            l,
            c = "velocity" === t && Ri ? t : Ui(t) && !B ? "element" : "start";
          return (
            "element" === c && ((a = So(q.target)), (l = So(t))),
            (n =
              "start" === c
                ? q.x - u
                : "velocity" === c
          ...
          if ((ut(!0), ct(), c && !_t())) {
            if (
              ...
              for (
                ...
                (l = (u = Mo(a.parentNode)) ? lo : a.parentNode),
                  U &&
        ...
        (i.enable = function (t) {
          var n,
            ...
            l = { lazy: !0 };
          if (
            (!1 !== r.cursor && (l.cursor = r.cursor || Li),
            vi.utils.checkPrefix("touchCallout") && (l.touchCallout = "none"),
            "soft" !== t)
          ) {
            for (
              ho(
              ...
              (a = j[i]),
                ...
                r.allowContextMenu || go(a, "contextmenu", at);
            Fo(j, !1);
          }
          return (
            bo(e, Tt),
            ...
            Ri &&
              "soft" !== t &&
              Ri.track(s || e, z ? "x,y" : B ? "rotation" : "top,left"),
            (e._gsDragID = n = e._gsDragID || "d" + io++),
            (no[n] = q),
        ...
        (i.disable = function (t) {
          for (var r, n = q.isDragging, i = j.length; --i > -1; )
            Eo(j[i], "cursor", null);
          if ("soft" !== t) {
            for (ho(j, null), i = j.length; --i > -1; )
              (r = j[i]),
                Eo(r, "touchCallout", null),
                mo(r, "mousedown", yt),
                mo(r, "touchstart", yt),
                mo(r, "click", Mt, !0),
                mo(r, "contextmenu", at);
          ...
          return (
            ...
            Ri &&
              "soft" !== t &&
              (Ri.untrack(s || e, z ? "x,y" : B ? "rotation" : "top,left"),
              q.tween && q.tween.kill()),
            s && s.disable(),
            po(lt),
            (q.isDragging = q.isPressed = O = !1),
            n && Po(q, "dragend", "onDragEnd"),
            q
          );
        }),
        ...
        (i.kill = function () {
          return (
            ...
            q.tween && q.tween.kill(),
            q.disable(),
            vi.set(j, { clearProps: "userSelect" }),
            delete no[e._gsDragID],
            q
          );
        }),
        (i.revert = function () {
        ...
        ~N.indexOf("scroll") &&
          ...
          (e.style.overflowY = U && !Di ? "auto" : "hidden"),
          (e.style.overflowX = W && !Di ? "auto" : "hidden"),
          (e = s.content)),
...
var Ho,
  ...
  Ko,
  $o = function () {
    return Ho || ("undefined" != typeof window && (Ho = window.gsap));
  },
  Qo = {},
  Zo = function (t) {
    return Ko(t).id;
  ...
  Jo = function (t) {
    return Qo[Zo("string" == typeof t ? Uo(t)[0] : t)];
  },
  ts = function (t) {
    var e,
      r = qo;
  ...
  ns = function (t, e, r, n) {
    (this.t = t),
      (this.p = e),
      (this.g = t._gsap.get),
      (this.rCap = es[r || Vo(this.g(t, e))]),
      (this.v1 = this.v2 = 0),
      (this.t1 = this.t2 = jo.time),
  ...
  is = (function () {
    ...
    return (
      ...
      (e.add = function (t, e) {
        t in this._props ||
          (qo || (jo.add(ts), (Go = jo.time)),
          (qo = this._props[t] = new ns(this.target, t, e, qo)));
      }),
      (e.remove = function (t) {
        var e,
          r,
        ...
        n &&
          ...
          (r = n._next),
          e && (e._next = r),
          r ? (r._prev = e) : qo === n && (jo.remove(ts), (qo = 0)),
          delete this._props[t]);
      }),
      (e.kill = function (t) {
        for (var e in this._props) this.remove(e);
        t || delete Qo[Zo(this.target)];
      }),
      (t.track = function (e, r, n) {
        ...
        for (
          ...
          for (i = Jo(a[h]) || new t(a[h]), o = l.length; o--; )
            i.add(l[o], u[o] || u[0]);
          s.push(i);
        }
        return s;
...
(is.getByTarget = Jo), $o() && Ho.registerPlugin(is);
var os,
  ss,
  as,
  ls,
  ...
  Ds = function t(e) {
    var r,
      n,
      i = {};
    for (r in e) i[r] = bs((n = e[r])) && !Ms(n) ? t(n) : n;
    return i;
  },
  Ss = function (t, e, r, n, i) {
    ...
    if (bs(t)) {
      ...
      if ((i || Os) < Os && i < Math.sqrt(c)) return t;
    } else
      for (; u--; )
        (s = (o = e[u]) - t) < 0 && (s = -s),
          s < c && o >= n && o <= r && ((h = u), (c = s));
  ...
  Ps = function (t, e, r, n, i, o, s) {
    if ("auto" === t.end) return t;
    var a,
      l,
      u = t.end;
    if (((r = isNaN(r) ? Os : r), (n = isNaN(n) ? -Os : n), bs(e))) {
      if (
        ((a = e.calculated ? e : (Ts(u) ? u(e, s) : Ss(e, u, r, n, o)) || e),
        !e.calculated)
      ) {
        for (l in a) e[l] = a[l];
        e.calculated = !0;
      ...
      a = a[i];
    } else a = Ts(u) ? u(e, s) : Ms(u) ? Ss(e, u, r, n, o) : parseFloat(u);
    return (
      a > r ? (a = r) : a < n && (a = n),
    ...
    if (e.linkedProps) {
      ...
      for (i = 0; i < h.length; i++)
        (s = e[(o = h[i])]) &&
          ((a = ws(s.velocity)
            ? s.velocity
            : (l = l || ys(t)) && l.isTracking(o)
            ? l.get(o)
            : 0),
          (u = Math.abs(a / As(s, "resistance", n))),
          (c[o] = parseFloat(r(t, o)) + Rs(a, u)));
      return c;
    }
  },
  Fs = function () {
    (os = xs()) &&
      ...
      (ps = os.core.getCache),
      (gs = os.utils.clamp),
      (_s = os.core.getStyleSaver),
      (vs = os.core.reverting || function () {}),
      (us = as("power3")),
      (ds = us(0.05)),
      (fs = os.core.PropTween),
      os.config({
        resistance: 100,
        unitFactors: {
          time: 1e3,
  ...
  Ns = {
    ...
    init: function (t, e, r, n, i) {
      ...
      (this.styles = _s && "object" == typeof t.style && _s(t)),
        (this.target = t),
        (this.tween = r),
        (ms = e);
      var s,
        ...
        x = As(e, "resistance", hs.resistance),
        w = ws(_)
          ? _
          : (function (t, e, r, n, i, o) {
              ...
              var s,
                ...
                v = e.inertia || e,
                y = ps(t).get,
                x = As(v, "resistance", hs.resistance);
              for (s in ((g = Ys(t, v, y, x)), v))
                Xs[s] ||
                  ((a = v[s]),
                  bs(a) ||
                    ((p = p || ys(t)) && p.isTracking(s)
                      ? (a = ws(a) ? { velocity: a } : { velocity: p.get(s) })
                  ...
                  bs(a) &&
                    ((u = ws(a.velocity)
                      ...
                      ? p.get(s)
                      : 0),
                    (l = gs(n, r, Math.abs(u / As(a, "resistance", x)))),
                    (c = (h = parseFloat(y(t, s)) || 0) + Rs(u, l)),
                    "end" in a &&
                      ((a = Ps(
                        a,
                        g && s in g ? g : c,
                    ...
                    "max" in a && c > +a.max + 1e-10
                      ? ((d = a.unitFactor || hs.unitFactors[s] || 1),
                        (f =
                          (h > a.max && a.min !== a.max) ||
                          (u * d > -15 && u * d < 45)
                            ? n + 0.1 * (r - n)
      ...
      for (s in ((e = ms), (ms = 0), (d = Ys(t, e, m, x)), e))
        Xs[s] ||
          ((a = e[s]),
          Ts(a) && (a = a(n, t, i)),
          ws(a)
            ? (h = a)
            : bs(a) && !isNaN(a.velocity)
            ? (h = +a.velocity)
          ...
          bs(a) &&
            ((f = l + c),
            "end" in a &&
              (a = Ps(a, d && s in d ? d : f, a.max, a.min, s, e.radius, h)),
            "max" in a && +a.max < f
          ...
          (this._pt = new fs(this._pt, t, s, l, 0, ks, 0, g.set(t, s, this))),
          (this._pt.u = u || 0),
          (this._pt.c1 = c),
          (this._pt.c2 = p));
    ...
    render: function (t, e) {
      var r = e._pt;
      if ((t = us(e.tween._time / e.tween._dur)) || !vs())
        for (; r; )
          r.set(r.t, r.p, Es(r.s + r.c1 * t + r.c2 * t * t) + r.u, r.d, t),
            (r = r._next);
      else e.styles.revert();
    },
  };
"track,untrack,isTracking,getVelocity,getByTarget"
  ...
  xs() && os.registerPlugin(Ns),
  Kn.registerPlugin(Io, Ns);
const zs = {
    toArray: Kn.utils.toArray,
    wrap: Kn.utils.wrap,
    snap: Kn.utils.snap,
    getProperty: Kn.getProperty,
    set: Kn.set,
    killTweensOf: Kn.killTweensOf,
  },
  Bs = {
    power1: Kn.parseEase("power1"),
    power2: Kn.parseEase("power2"),
    power3: Kn.parseEase("power3"),
    power4: Kn.parseEase("power4"),
    back: Kn.parseEase("back"),
    elastic: Kn.parseEase("elastic"),
    bounce: Kn.parseEase("bounce"),
    sine: Kn.parseEase("sine"),
    circ: Kn.parseEase("circ"),
    expo: Kn.parseEase("expo"),
  },
  Is = {
    slideIn: { x: 0, duration: 0.5, ease: "power2.out" },
    slideOut: { x: -100, duration: 0.3, ease: "power2.in" },
    fadeIn: { opacity: 1, duration: 0.4, ease: "power2.out" },
    fadeOut: { opacity: 0, duration: 0.3, ease: "power2.in" },
    scaleUp: { scale: 1.1, duration: 0.3, ease: "back.out(1.7)" },
    scaleDown: { scale: 1, duration: 0.3, ease: "power2.out" },
  };
export {
  Io as Draggable,
  Ns as InertiaPlugin,
  Is as animationPresets,
  Bs as easing,
  Kn as gsap,
  zs as gsapUtils,
};
