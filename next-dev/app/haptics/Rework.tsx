import { useWebHaptics, PRESET_TRIGGERS } from "https://cdn.jsdelivr.net/gh/framer-university/components/npm-bundles/haptics-3.js";
import { addPropertyControls, ControlType, RenderTarget } from "framer";
import { useEffect, useRef, useCallback } from "react";

/** Preset names matching PRESET_TRIGGERS from the bundle. */
...
addPropertyControls(HapticsFramer, {
  ...
  debug: {
    ...
    defaultValue: false,
    description:
      "For development purposes only. Will play a sound on desktop.\n\nMore components at [Framer University](https://frameruni.link/cc).",
  },
});
